    ...
    const std::shared_ptr<LocalizationRegions>& lrs)
{
    ...
    gfv_work_ = new pb::GridFuncVector<MGPRECONDTYPE, memory_space_type>(mygrid, ct.bcWF[0],
        ct.bcWF[1], ct.bcWF[2], orbitals.getOverlappingGids());

    data_wghosts_ = new pb::GridFuncVector<MGPRECONDTYPE, memory_space_type>(mygrid, ct.bcWF[0],
        ct.bcWF[1], ct.bcWF[2], orbitals.getOverlappingGids());
